 ...
 */
function emitError() {
    return env(0 /* EMIT_ERROR */, true, toBoolean);
}
/**
 ...
 */
function useCache() {
    return env(1 /* USE_CACHE */, true, toBoolean);
}
/**
...
function compilerOptions() {
    return env(2 /* COMPILER_OPTIONS */, defaultCompilerOptions, toOptions);
}
/**
...
function compile(filename, options) {
    ...
    if (emitError()) {
        checkErrors(program.getDiagnostics().concat(checker.getDiagnostics().concat(result.diagnostics)));
    }
}
/**
